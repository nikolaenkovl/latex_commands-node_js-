var dbProperties = {
    database: 'latex_commands', // название базы данных
...
db.command= require('../model/command.model.js')(sequelize, Sequelize);
db.user_command = require('../model/user_command.model.js')(sequelize, Sequelize);
